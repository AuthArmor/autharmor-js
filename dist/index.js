...
// @ts-ignore
var kjua_1 = __importDefault(require("kjua"));
var index_1 = __importDefault(require("./config/index"));
var images_json_1 = __importDefault(require("./assets/images.json"));
var AuthArmorSDK = /** @class */ (function () {
    function AuthArmorSDK(_a) {
        ...
        this.popupWindow = function (url, title, width, height) {
        ...
        this.init({ polling: polling });
    }
    AuthArmorSDK.prototype.init = function (_a) {
        var _this = this;
        ...
        window.AuthArmor.closedWindow = function () {
    ...
    AuthArmorSDK.prototype.on = function (eventName, fn) {
        ...
        var listeners = (_a = this.eventListeners.get(eventName)) !== null && _a !== void 0 ? _a : [];
